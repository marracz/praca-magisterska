...
for alg in ALG_CLASSES:
        for x in NEIGHBOURHOOD_SIZE:
                for fold in range(10):
                        params = ["java", "-Xmx4096m", "-Xms2048m", "-cp", JAR, MAIN_CLASS, TASK, DATASET, MODEL_CLASS, alg, x, "./BX-Book-Ratings" + str(fold) + "_training.csv", "./BX-Book-Ratings" + str(fold) + "_test.csv"]
                        print(params)
